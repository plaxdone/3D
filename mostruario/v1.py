...
with open(f'{path}\\listaOK.csv', 'r') as arquivo_referencia:
    ...
    for item in tabela:
        ...
        img1 = resize(img1, (int(tamImg*pxl)))
        img2 = Image.open(f'{path}\\{item[1]}')
        img2 = resize(img2, (int(tamImg*pxl)))
        ...
        # marca = Image.open('C:\\Users\\Jorge\\Desktop\\mostruario\\marca.png')
